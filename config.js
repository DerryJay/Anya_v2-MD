...
module.exports = {
  botname: process.env.BotName || "Jay V2", 
  author: process.env.Author || "@Jay",
  packname: process.env.PackName || "Kishi💔",
  socialLink: process.env.Web || "https://github.com/PikaBotz",
  footer: process.env.Footer || "© Jay's Bot",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "Jay~Kun",
  ownernumber: process.env.Owner_Number || "2348100322985",
